...
import 'package:spotify_app/app/presentation/views/search_songs/widgets/song_list_search.dart';
      ...
      slivers: [
        SliverAppBar(
          ...
          title: TextField(
            ...
            onChanged: (value) {
              ref.read(songListSearchStateProvider.notifier).search(value);
            },
          ),
        ),
